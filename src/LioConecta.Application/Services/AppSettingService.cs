    ...
    ICurrentUserService currentUserService) : IAppSettingService
{
    ...
    private static readonly Dictionary<string, (string Label, string? Description)> CategoryMeta =
        new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["auth"] = ("Autenticação", "Provedor LDAP, JWT do portal e políticas de acesso."),
            ["ldap"] = ("LDAP / Active Directory", "Autenticação corporativa por e-mail e senha."),
    ...
    [
        ...
        AppSettingKeys.AuthProvider,
        AppSettingKeys.AuthJwtSigningKey,
        AppSettingKeys.AuthJwtExpiryMinutes,
        AppSettingKeys.AuthSuperAdminEmails,
        AppSettingKeys.LdapEnabled,
        AppSettingKeys.LdapHost,
        AppSettingKeys.LdapPort,
        AppSettingKeys.LdapUseSsl,
        AppSettingKeys.LdapBindDn,
        AppSettingKeys.LdapBindPassword,
        AppSettingKeys.LdapSearchBase,
        AppSettingKeys.LdapUserFilter,
        AppSettingKeys.LdapDomain,
