...
public static class WorkerRegistry
{
    ...
    [
        ...
        new(
            ...
            "Publicação programada de comunicados",
            "Publica comunicados agendados quando sua data e hora são atingidas.",
        ...
        new(
            ...
            "Publicação programada de notícias",
            "Publica notícias agendadas no feed quando sua data e hora são atingidas.",
            AppSettingKeys.WorkersNewsScheduleIntervalMinutes,
            1,
            HostedInWorkersProcess: true,
            DependsOn: [WorkerConnectivityIds.Postgres, WorkerConnectivityIds.Api]),
        new(
            ...
            "Publica no feed as admissões recentes ainda não anunciadas.",
