...
public static class AppSettingCatalog
{
    ...
    [
        ...
        new(AppSettingKeys.LeaveRmWriteBackEnabled, "leave", "Write-back férias RM habilitado",
            "Quando true, tenta enviar solicitações ao middleware/API TOTVS RM.", "boolean", false, "false", 1),
