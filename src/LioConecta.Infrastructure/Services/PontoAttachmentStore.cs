...
public sealed class PontoAttachmentStore(IHostEnvironment hostEnvironment) : IPontoAttachmentStore
{
    public const long MaxFileSizeBytes = PontoAttachmentLimits.MaxFileSizeBytes;
    public const int MaxFilesPerRequest = PontoAttachmentLimits.MaxFilesPerRequest;
    public const string PublicPathPrefix = "/ponto/attachments";
    ...
    public async Task<PontoAttachmentMetaDto> SaveAsync(
        Stream content,
        string fileName,
        string? contentType,
        long sizeBytes,
    ...
    private string ResolveRoot() =>
        Path.Combine(hostEnvironment.ContentRootPath, "App_Data", "ponto", "attachments");
